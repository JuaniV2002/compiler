...
**Código**: `integer resultado = (3 + 5) * 2 - 8 / 4;`
...
**Código**: `boolean resultado = (a && b) || !a;`
...
**Código**: `integer resultado = suma(multiplica(2, 3), 5);`
...
Ventajas: secuencia lineal, temporales explícitos, fácil de optimizar.
